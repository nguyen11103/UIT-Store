        ...
        <div class="carousel-inner">
            <?php if (isset($slide_active)) : ?>
                <div class="carousel-item active">
                    <a href="<?= $slide_1['slide_link'] ?>">
                        <img src="../back-end/img/<?= $slide_1['slide_image'] ?>" class="d-block w-100 carousel-img" alt="...">
                    </a>
                </div>
            <?php endif; ?>
            <?php foreach ($slide as $s) { ?>
                <div class="carousel-item">
                    <a href="<?= $s['slide_link'] ?>">
                        <img src="../back-end/img/<?= $s['slide_image'] ?>" class="d-block w-100 carousel-img" alt="...">
                    </a>
                </div>
            <?php } ?>
        </div>
                ...
                <div class="col-md-4" style="padding-left: 0; padding-right: 0;">
                    <div class="product-hover">
                        <div class="produc-img" style="position: relative;">
                            <a href="<?= $c['slide_link'] ?>">
                                <img src="../back-end/img/<?= $c['slide_image'] ?>" width="100%" alt="">
                            </a>
                            <div style="height: 100px; position: absolute; bottom: 0px; background-color: rgba(0, 0, 0, 0.5); width: 100%; text-align: left;">
                                <p class="text mt-2" style="margin-left: 20px; font-weight: bold; color: white;">Bộ Sưu Tập</p>
                            </div>
                        </div>
                    </div>
                </div>
