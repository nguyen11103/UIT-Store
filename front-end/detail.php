                    ...
                    <form action="" method="post">
                        <div>
                            ...
                            <div class="input_qty">
                                ...
                                <input class="qty" name="quantity" max="100" type="number" min="1" value="1" id="qty">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <?php foreach ($cmt  as $c) : ?>
                    <div class="comment">
                        <div class="avatar">
                            <img src="/back-end/img/avatar/<?= $c['avatar'] ?>" style="border-radius: 50%;" width="50px" height="50px" alt="">
                        </div>
